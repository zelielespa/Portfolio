...
<body>
    <div class="container">
        ...
        <div>
            <a href="logoandbranding.php" class="btn btn-secondary">Retour</a>
        </div>
        <h2>Modifier un produit</h2>
        <form action="treatmentUpdateLogoandbranding.php?id=<?= $id ?>" method="POST" enctype="multipart/form-data">
